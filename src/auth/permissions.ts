export const routePermissionMap: Record<string, string> = {
  ...
  "/admin": "admin.view",
  "/gestion-codigos": "productos.manage",
  "/auditoria": "logs.view",
  "/correcciones": "correcciones.view",
  "/autorizaciones": "autorizaciones.view",
  "/documentos-borradores": "documentos-borradores.view",
  "/salud-operativa": "sistema.salud.view",
  "/alertas": "alertas.manage",
  ...
  "/reportes/reporte-mensual": "reportes.reporte-mensual.view",
